...
export default function Hero() {
  return (
    <section id="hero" className="position-relative overflow-hidden border-bottom border-cream" style={{ backgroundColor: '#FFFDF9' }}>
      <div className="container-fluid px-3 px-md-4 px-xl-5">
        <div className="row align-items-center gy-4 gy-lg-0">
          ...
          <div className="col-12 col-lg-6 d-flex flex-column align-items-center justify-content-center py-4 py-lg-5 px-3 px-md-4 text-center">
            ...
            {/* Headline with Exact 26px Font Size, Line-height, and Color Overrides */}
            <h1 
